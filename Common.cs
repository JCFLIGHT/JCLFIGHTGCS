...
namespace JCFLIGHTGCS
{
    ...
    {
        static readonly Size SizeSt = new Size(Properties.Resources.marker_01.Width, Properties.Resources.marker_01.Height);
        ...
        public override void OnRender(Graphics g)
        {
            ...
            g.DrawImageUnscaled(pic, pic.Width / -2 - 4, -pic.Height - 10);
            Font drawFont = new Font(FontFamily.GenericMonospace, 9.0F, FontStyle.Bold);
            SolidBrush drawBrush = new SolidBrush(Color.White);
            drawBrush.Color = Color.Yellow;
            g.DrawString("WP", drawFont, drawBrush, -12, -53);
            drawBrush.Color = Color.White;
            if (WPNumber < 10) g.DrawString(String.Format("{0:0}", WPNumber), drawFont, drawBrush, -9, -42);
            if (WPNumber < 100 && WPNumber > 9) g.DrawString(String.Format("{0:0}", WPNumber), drawFont, drawBrush, -12, -43);
